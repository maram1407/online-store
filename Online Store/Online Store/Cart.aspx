<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="Online_Store.Cart" %>
                    ...
                    <div style="padding-top: 50px">
                                ...
                                <ItemTemplate>
                                    ...
                                    <div class="media" style="border: 1px solid black;">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <%-- <p class="proPrice" style="color: #FF00FF">Цвет.&nbsp <%# Eval("ColorNamee") %> </p>--%>
                                            <span class="proPrice">Цена.&nbsp <%# Eval("PPrice") %></span>
                        ...
                        <div class="col-md-3" runat="server" id="divAmountSect">
                            <div>
                                ...
                                <br />
                                    <div>
                                        <h5 style="font-weight: bold ; text-align:center">  Выберите способ оплаты</h5>
                                        <%--<asp:Button ID="btnBuyNow"  CssClass="buyNowbtn" runat="server" OnClick="btnBuyNow_Click" Text="формирования заказа" />--%>
                                    </div>
                                <div>
                                    <asp:Button ID="btnHal"  CssClass="buyNowbtn" runat="server" OnClick="btnHal_Click" Text="НАЛИЧНЫЕ" />
                                    <asp:Button ID="btnCart"  CssClass="buyNowbtn" runat="server" OnClick="btnCart_Click" Text="КАРТЫ" />
                                </div>
                                </div>
                            </div>
                        </div>
