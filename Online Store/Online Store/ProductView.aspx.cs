...
namespace Online_Store
{
    public partial class ProductView : System.Web.UI.Page
    {
        ...
        protected void rptrProductDetails_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                string TypeID = (e.Item.FindControl("hfTypeID") as HiddenField).Value;
                ...
                using (SqlConnection con = new SqlConnection(CS))
                {
                    using (SqlCommand cmd = new SqlCommand("select * from tblColors where  CategoryID=" + CatID + "  and TypeID=" + TypeID + "", con))
                    {
                        cmd.CommandType = CommandType.Text;
                        using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                        {
        ...
        protected void btnAddtoCart_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem item in rptrProductDetails.Items)
            {
                ...
                {
                    var rbList = item.FindControl("rblColor") as RadioButtonList;
            ...
            else
            {
                foreach (RepeaterItem item in rptrProductDetails.Items)
                {
                    ...
                    {
                        var lblError = item.FindControl("lblError") as Label;
                        lblError.Text = "Пожалуйста выберите цвет";
                    }
                }
